...
if (!$inv_img) {
    ...
    $hero_ids = get_posts(['post_type' => 'attachment', 'name' => 'alexis-residences_final-stills_exterior_1', 'post_status' => 'inherit', 'posts_per_page' => 1, 'fields' => 'ids']);
    if ($hero_ids) {
        $inv_img = wp_get_attachment_image((int) $hero_ids[0], 'imaani-hero', false, ['loading' => 'eager', 'class' => 'abx-hero__img', 'alt' => 'Alexis Residence, a luxury Imaani Homes development in Accra']);
    }
